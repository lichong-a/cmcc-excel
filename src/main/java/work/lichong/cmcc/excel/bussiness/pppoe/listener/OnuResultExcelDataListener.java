...
import work.lichong.cmcc.excel.bussiness.pppoe.dao.OnuResultRespository;
...
public class OnuResultExcelDataListener implements ReadListener<OnuResultEntity> {
    ...
    private OnuResultRespository repository;

    public OnuResultExcelDataListener(OnuResultRespository repository) {
